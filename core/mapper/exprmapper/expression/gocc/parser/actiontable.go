...
var actionTab = actionTable{
	...
	actionRow{ // S23
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(42), /* $, reduce: DoubleQString */
			reduce(42), /* ||, reduce: DoubleQString */
			reduce(42), /* &&, reduce: DoubleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S24
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(43), /* $, reduce: SingleQString */
			reduce(43), /* ||, reduce: SingleQString */
			reduce(43), /* &&, reduce: SingleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S32
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(92),  /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(101), /* doublequotes_string */
			shift(102), /* singlequote_string */
			shift(103), /* number */
			shift(104), /* argument */
			shift(105), /* true */
			shift(106), /* false */
	...
	actionRow{ // S79
		...
		actions: [numSymbols]action{
			...
			nil,        /* ? */
			nil,        /* : */
			shift(138), /* doublequotes_string */
			shift(139), /* singlequote_string */
			shift(140), /* number */
			shift(141), /* argument */
			shift(142), /* true */
			shift(143), /* false */
	...
	actionRow{ // S147
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(180), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(189), /* doublequotes_string */
			shift(190), /* singlequote_string */
			shift(191), /* number */
			shift(192), /* argument */
			shift(193), /* true */
			shift(194), /* false */
