...
var actionTab = actionTable{
	actionRow{ // S0
		...
		actions: [numSymbols]action{
			...
			nil,       /* ? */
			nil,       /* : */
			shift(23), /* doublequotes_string */
			shift(24), /* singlequote_string */
			shift(25), /* number */
			shift(26), /* argument */
			shift(27), /* true */
			shift(28), /* false */
	...
	actionRow{ // S23
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(44), /* $, reduce: DoubleQString */
			reduce(44), /* ||, reduce: DoubleQString */
			reduce(44), /* &&, reduce: DoubleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S24
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(45), /* $, reduce: SingleQString */
			reduce(45), /* ||, reduce: SingleQString */
			reduce(45), /* &&, reduce: SingleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S78
		...
		actions: [numSymbols]action{
			...
			nil,        /* ? */
			nil,        /* : */
			shift(110), /* doublequotes_string */
			shift(111), /* singlequote_string */
			shift(112), /* number */
			shift(113), /* argument */
			shift(114), /* true */
			shift(115), /* false */
	...
	actionRow{ // S80
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(130), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(140), /* doublequotes_string */
			shift(141), /* singlequote_string */
			shift(142), /* number */
			shift(143), /* argument */
			shift(144), /* true */
			shift(145), /* false */
	...
	actionRow{ // S82
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(159), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(168), /* doublequotes_string */
			shift(169), /* singlequote_string */
			shift(170), /* number */
			shift(171), /* argument */
			shift(172), /* true */
			shift(173), /* false */
