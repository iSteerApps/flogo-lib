...
var actionTab = actionTable{
	...
	actionRow{ // S24
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(45), /* $, reduce: DoubleQString */
			reduce(45), /* ||, reduce: DoubleQString */
			reduce(45), /* &&, reduce: DoubleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S25
		...
		actions: [numSymbols]action{
			nil,        /* INVALID */
			reduce(46), /* $, reduce: SingleQString */
			reduce(46), /* ||, reduce: SingleQString */
			reduce(46), /* &&, reduce: SingleQString */
			nil,        /* ( */
			nil,        /* ) */
	...
	actionRow{ // S81
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(105), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(115), /* doublequotes_string */
			shift(116), /* singlequote_string */
			shift(117), /* number */
			shift(118), /* argument */
			shift(119), /* true */
			shift(120), /* false */
	...
	actionRow{ // S83
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(136), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(146), /* doublequotes_string */
			shift(147), /* singlequote_string */
			shift(148), /* number */
			shift(149), /* argument */
			shift(150), /* true */
			shift(151), /* false */
	...
	actionRow{ // S85
		...
		actions: [numSymbols]action{
			...
			nil,        /* / */
			nil,        /* % */
			shift(166), /* function_name */
			nil,        /* () */
			nil,        /* , */
			nil,        /* ? */
			nil,        /* : */
			shift(175), /* doublequotes_string */
			shift(176), /* singlequote_string */
			shift(177), /* number */
			shift(178), /* argument */
			shift(179), /* true */
			shift(180), /* false */
